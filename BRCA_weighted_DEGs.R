...
if (file.exists("./pathways_GOEGCN")==FALSE){
  dir.create("./pathways_GOEGCN")
}
...
write.csv(subtype_weighted_DEGs_classification, "ds2_weighted_DEGs_classification.csv", row.names=FALSE)
